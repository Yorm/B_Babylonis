...
public class XCellRenderer extends DefaultTableCellRenderer {
	...
	private final static int TREE_TYPE_COLOR_X                = 0x22B14C;
	...
	private static int getForegroundColor(long cellData) {
		...
		if (humanType == XUcfCoder.HUMAN_TYPE_EMPTY || plantType == XUcfCoder.PLANT_TYPE_EMPTY) {
